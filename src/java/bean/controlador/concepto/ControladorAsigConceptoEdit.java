 ...
 * @author hpulgar
 */
public class ControladorAsigConceptoEdit extends GenericForwardComposer {

    private Button btnAdd, btnEdit;
    private Selectbox slbTipoNomina, slbTrabajador, slbConcepto;
    ...
    private Label lblTipoConcepto; 
    private Textbox txtInicializable;  
    //rivate java.util.Date ssnFechaNomina = (java.util.Date) Sessions.getCurrent().getAttribute("ssnFechaNomina");
    //private Combobox cbbInicializable;
    //private Button   btnIniValores;    
    ...
    public void onClick$btnIniValores() {
        //System.out.println("cbbIni="+cbbInicializable.getText());
    }
    ...
    //--------------------------------------------------------------------------
    public void onSelect$slbConcepto() {
        //System.out.println("========AQUICA(onSelectConcepto)===txtInic="+txtInicializable.getText()+" ****");
    }
}
