 ...
 * @author henrypb
 */
public class NomConfigDatJpaController implements Serializable {
     ...
     */
    public NomConfigDatJpaController() {
    ...
    private void updateRecord(EntityManager em) {
        //EntityManager em = getEntityManager();
        Query query = em.createNativeQuery("update NomConfig_Dat set rutaAbsFoto=?");
        query.setParameter(1, "/miRuta/kkkkkkkkkkkkkkk");
        query.executeUpdate();
    }  // addRecord() 
