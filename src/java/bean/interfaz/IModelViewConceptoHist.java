 ...
 * @author hpulgar
 */
public interface IModelViewConceptoHist {
    ...
    //                                        get_ViewModel()
    //--------------------------------------------------------------------------
    public abstract ListModel<AsigConcepto> getConceptoHistViewModel();  
    ...
    //--------------------------------------------------------------------------
    //                                       get_ViewFilter()
    public abstract AsigConceptoViewFilter getConceptoHistViewFilter();
