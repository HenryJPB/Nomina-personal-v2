 ...
 */
@Embeddable
public class NomCalculoDatPK implements Serializable {
    ...
    public NomCalculoDatPK() {
    }

    public NomCalculoDatPK(String rifEmpresa, int codNomina, int nroTrabajador, int codConcepto, Date fechaNomina) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NomCalculoDatPK)) {
            return false;
        }
        NomCalculoDatPK other = (NomCalculoDatPK) object;
    ...
    public String toString() {
        return "bean.modelo.entidad.NomCalculoDatPK[ rifEmpresa=" + rifEmpresa + ", codNomina=" + codNomina + ", nroTrabajador=" + nroTrabajador + ", codConcepto=" + codConcepto + ", fechaNomina=" + fechaNomina + " ]";
    }
