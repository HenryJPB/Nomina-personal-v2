 ...
 */
@Embeddable
public class NomTrabajador00DatPK implements Serializable {
    ...
    public NomTrabajador00DatPK() {
    }

    public NomTrabajador00DatPK(String rifEmpresa, int nroTrabajador) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NomTrabajador00DatPK)) {
            return false;
        }
        NomTrabajador00DatPK other = (NomTrabajador00DatPK) object;
    ...
    public String toString() {
        return "bean.entidad.NomTrabajador00DatPK[ rifEmpresa=" + rifEmpresa + ", nroTrabajador=" + nroTrabajador + " ]";
    }
