 ...
 */
@Embeddable
public class NomAsigConceptoDatPK implements Serializable {
    ...
    public NomAsigConceptoDatPK() {
    }

    public NomAsigConceptoDatPK(String rifEmpresa, int codNomina, int nroTrabajador, int codConcepto) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NomAsigConceptoDatPK)) {
            return false;
        }
        NomAsigConceptoDatPK other = (NomAsigConceptoDatPK) object;
    ...
    public String toString() {
        return "bean.modelo.entidad.NomAsigConceptoDatPK[ rifEmpresa=" + rifEmpresa + ", codNomina=" + codNomina + ", nroTrabajador=" + nroTrabajador + ", codConcepto=" + codConcepto + " ]";
    }
