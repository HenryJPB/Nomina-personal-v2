 ...
 */
@Embeddable
public class NomCalculo1DatPK implements Serializable {
    ...
    public NomCalculo1DatPK() {
    }

    public NomCalculo1DatPK(String rifEmpresa, int codNomina, int nroTrabajador, int codConcepto, Date fechaNomina) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NomCalculo1DatPK)) {
            return false;
        }
        NomCalculo1DatPK other = (NomCalculo1DatPK) object;
    ...
    public String toString() {
        return "bean.modelo.entidad.NomCalculo1DatPK[ rifEmpresa=" + rifEmpresa + ", codNomina=" + codNomina + ", nroTrabajador=" + nroTrabajador + ", codConcepto=" + codConcepto + ", fechaNomina=" + fechaNomina + " ]";
    }
