...
<html>
    ...
    <body>
    <center> <h3>RECIBOS NOMINA</h3> </center>
    </body>
    <%
        ...
        //parametros.put("p_tipo_nomina", Integer.parseInt(request.getParameter("tipo_nomina")) );
        ...
        String trabajador1 = request.getParameter("n_trabajador1");  
         if ( trabajador1==null || trabajador1.isEmpty()) { 
            trabajador1="0";  
        }
        //
        String trabajador2 = request.getParameter("n_trabajador2");  
        if ( trabajador2==null || trabajador2.isEmpty()) { 
            trabajador2="0";  
        }
        //
        parametros.put("p_trabajador1", Integer.parseInt( trabajador1 ) );
        parametros.put("p_trabajador2", Integer.parseInt( trabajador2 ) );
        //
        String fechaNominaS = request.getParameter("fecha");  
        //fechaNominaS = "2020-09-30";  
