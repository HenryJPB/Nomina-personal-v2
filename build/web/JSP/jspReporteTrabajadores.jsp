<%-- 
    ...
    Author     : hpulgar
--%>
<%@page import="bean.modelo.entidad.NomTrabajador01Dat"%>
...
<html>
    ...
    <%
        ...
        //
        File reportFile = new File(application.getRealPath("/REPORTES//MaestroPersonal.jasper"));
        ...
        //parametros.put("p_rif_empresa","J-41309179-8");
        parametros.put("p_rif_empresa",empresa);
        //parametros.put("p_rif_empresa", paramEmpresa );
